...
const QUIZ_QUESTIONS = [
  {
    ...
    type: 'single',
    options: [
      { value: 'patient', label: 'Patient', description: "I am the transplant patient" },
      { value: 'carepartner', label: 'Family or Caregiver', description: "I am helping a loved one" },
      { value: 'social_worker', label: 'Social Worker or Coordinator', description: "I work in healthcare" },
    ],
  },
  {
    id: 'transplant_stage',
    ...
    type: 'single',
    options: [
      { value: 'pre', label: 'Before transplant', description: 'Waiting or in evaluation' },
      { value: 'post_1yr', label: 'After transplant (first year)', description: 'Within the first year' },
      { value: 'post_1yr_plus', label: 'After transplant (1+ years)', description: 'More than a year after' },
    ],
  },
  {
    id: 'organ_type',
    ...
    options: [
      ...
      { value: 'multi', label: 'More than one organ' },
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { value: 'commercial', label: 'From my job', description: 'Private insurance from work', hint: 'Copay cards can help!' },
      { value: 'medicare', label: 'Medicare', description: 'Government program (age 65+ or disabled)', hint: 'Foundations and free programs' },
      { value: 'medicaid', label: 'Medicaid', description: 'State program based on income', hint: 'Usually good coverage' },
      { value: 'tricare_va', label: 'TRICARE / VA', description: 'Military or veteran benefits' },
      { value: 'ihs', label: 'Indian Health Service', description: 'Tribal health programs' },
      { value: 'uninsured', label: 'No insurance', description: 'No current insurance', hint: 'Free medicine programs can help' },
    ],
  },
  {
    id: 'medication',
    question: "Which medicine do you need help with?",
    helpText: "Pick from common drugs for your transplant, or search for others",
    type: 'medication_search',
    allowSkip: true,
    skipLabel: "Skip - show general help",
  },
  {
    id: 'cost_burden',
    ...
    type: 'single',
    options: [
      { value: 'manageable', label: 'OK', description: "I can afford my medicine" },
      { value: 'challenging', label: 'Tight', description: "It is hard, but I manage" },
      { value: 'unaffordable', label: 'Too much', description: "I have trouble paying" },
      { value: 'crisis', label: 'Urgent', description: "I have skipped doses to save money", urgent: true },
    ],
  },
];
