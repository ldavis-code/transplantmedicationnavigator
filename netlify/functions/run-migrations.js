...
const MIGRATIONS = [
  ...
  },
  {
    ...
    // Organs are lowercase and stage is 'post' because the live table's
    // medications_organs_chk constraint (added in Neon) rejects the
    // title-case forms 047 used. Keyed on the stale brand_name so a re-run
    // is a no-op; the INSERT is ON CONFLICT DO NOTHING.
