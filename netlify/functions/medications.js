...
function transformMedication(row) {
    return {
        ...
        papUrl: row.pap_url || row.pap_program_url,
        papProgramId: row.pap_program_id || row.pap_program_name,
        copayUrl: row.copay_program_url,
        copayProgramId: row.copay_program_name,
