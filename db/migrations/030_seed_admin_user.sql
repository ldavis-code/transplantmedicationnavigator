...
--   Email: admin@transplantmedicationnavigator.com
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@transplantmedicationnavigator.com') THEN
    INSERT INTO users (org_id, email, password_hash, name, role, is_active, email_verified)
    VALUES (
      public_org_id,
      'admin@transplantmedicationnavigator.com',
