    ...
    if (compact) {
        return (
            <button
                ...
                className="inline-flex items-center gap-1.5 px-2 py-2 bg-white hover:bg-emerald-50 text-emerald-700 text-sm font-semibold rounded-lg border border-emerald-300 transition min-h-[44px] min-w-[44px] justify-center whitespace-nowrap"
            >
