...
const savingsPrograms = [
  ...
  {
    medication_id: null,
    program_name: 'American Transplant Foundation Patient Assistance',
    program_type: 'foundation',
    commercial_eligible: true,
    medicare_eligible: true,
    medicaid_eligible: true,
    ...
    ihs_tribal_eligible: true,
    income_limit: 'Varies',
    max_benefit: 'Emergency grants up to $1,000',
    application_url: 'https://www.americantransplantfoundation.org/patient-family-services/patient-assistance-program/',
    phone: '1-303-757-0959',
    notes: 'Emergency assistance for medications, travel, living expenses.',
    is_active: true
  },
  {
    medication_id: null,
    program_name: 'NeedyMeds Drug Discount Card',
    program_type: 'discount_card',
    commercial_eligible: true,
    medicare_eligible: true,
    medicaid_eligible: true,
    ...
    ihs_tribal_eligible: true,
    income_limit: 'None',
    max_benefit: 'Up to 80% savings',
    application_url: 'https://www.needymeds.org/drug-discount-card',
    notes: 'Free card, no registration. Works at most pharmacies.',
    is_active: true
  },
  {
    medication_id: null,
    program_name: 'RxAssist Patient Assistance Database',
    program_type: 'foundation',
    commercial_eligible: true,
    medicare_eligible: true,
    medicaid_eligible: true,
    ...
    ihs_tribal_eligible: true,
    income_limit: 'Varies',
    max_benefit: 'Search database for programs',
    application_url: 'https://www.rxassist.org',
    notes: 'Comprehensive database of patient assistance programs.',
    is_active: true
  },
  {
    medication_id: null,
    program_name: 'Medicare Extra Help (Low Income Subsidy)',
    program_type: 'foundation',
    commercial_eligible: false,
    medicare_eligible: true,
    medicaid_eligible: false,
    ...
    tricare_va_eligible: false,
    ihs_tribal_eligible: false,
    income_limit: '150% FPL or limited resources',
    max_benefit: 'Reduces Part D copays to $0-$11/month',
    application_url: 'https://www.ssa.gov/benefits/medicare/prescriptionhelp/',
    notes: 'Apply through Social Security. Dramatically reduces Part D costs.',
    is_active: true
  }
];
